...
import { Wallet, Copy, ArrowRight, ArrowLeft, Clock, CheckCircle, XCircle, History, ShieldAlert, Coins, Timer, QrCode, Loader2, RefreshCw, AlertTriangle, Crown } from 'lucide-react';
...
export default function Topup() {
  ...
  const fetchPrices = useCallback(async () => {
    ...
    try {
      ...
      setPriceError(true);
      toast.error('Could not sync live crypto rates.');
    } finally {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-5 flex flex-col gap-6">
          <section className="bg-[#11141d] border border-slate-800 rounded-3xl p-6 md:p-8 shadow-lg relative overflow-hidden">
            ...
            {user?.isVip && step === 1 && (
              <div className="mb-6 p-4 bg-gradient-to-r from-amber-500/10 to-orange-500/5 border border-amber-500/30 rounded-2xl flex items-center gap-3 shadow-inner animate-in fade-in">
